...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/mon.jpg)'}">
		<div class="scene">
...
export default {
  data() {
    ...
    return {
      ...
      // path:'',//当前打开页面的路径
      input: "", //input输入内容
      headBg: "url(static/img/mon.jpg)", //头部背景图
      headTou: "", //头像
      projectList: "" //项目列表
    };
  },
